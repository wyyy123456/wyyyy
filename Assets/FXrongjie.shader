...
Shader "Shader Forge/FXrongjie" {
    Properties {
        ...
        _node_9908 ("node_9908", Range(0, 6.3)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_9282 = (pow(((_niuqutu_var.r*_rongjie)+_rongjie),3.0)*pow((_rongjie+(_rongjie*node_575.r)),10.0));
                clip(node_9282 - 0.5);
////// Lighting:
////// Emissive:
